...
// Init 方法实现
func (h *FileUploadHandler) Init(request dto.WsRequestDto) {
	h.request = request
}

// Execute 方法实现
func (h *FileUploadHandler) Execute() dto.WsResponseDto {
...
func (ic *FileUploadHandler) create(folderPath string, name string) error {
